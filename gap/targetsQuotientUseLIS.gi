...
##                      `LINS_FindTQuotients`
##
##  with the argument `targets` set to this, if the optional argument
##
##                      `UseLIS` = `true`
#############################################################################
##  Description:
...
##  Then the pregenerated list `LINS_TargetsQuotient_UseLIS` contains
...
##
##  The list `LINS_TargetsQuotient_UseLIS` is sorted by information $1$.
#############################################################################

BindGlobal("LINS_TargetsQuotient_UseLIS_Index", 10000000);

BindGlobal("LINS_TargetsQuotient_UseLIS",
[ [              60,               5,          "A5^1" ],
  [             120,               5,          "A5^1" ],
  [             168,               7,    "PSL(2,7)^1" ],
  [             336,               8,    "PSL(2,7)^1" ],
