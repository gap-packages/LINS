...
GAP_profile := [ [ 1016, 1, 0, 0, 0, "", "IsPowerOf" ], 
  ...
  [ 916, 4, 1, 471096, 0, "", "MustCheckP" ], 
  [ 916, 5, 3, 1137824, 33856, "", "MinSubgroupSizes" ], 
  [ 1907, 119, 6, 13815976, 113104, "(oprt.)", "GroupHomomorphismByImagesNC" ]
    , [ 10816, 131, 3, 15186030, 0, "GAP", "GModuleByMats" ], 
  [ 339, 341, 0, 24842512, 0, "(oprt.)", "NaturalHomomorphismBySubspace" ], 
  [ 550157, 364, 38, 14221184, 0, "(oprt.)", "GeneratorsOfMagmaWithInverses" ]
    , [ 128693, 504, 11, 85886040, 255472, "(oprt.)", "Index" ], 
  [ 468, 468, 61, 50469472, 6346916, "(oprt.)", "EpimorphismQuotientSystem" ],
  [ 2, 1412, 18, 179506504, 598624, "(oprt.)", "LowIndexSubgroupsFpGroup" ], 
  [ 557, 1466, 8, 106827176, 805262, "(oprt.)", "IsomorphismFpGroup" ], 
  [ 89368, 2194, 7, 183124680, 0, "", "ExponentSum" ], 
  [ 84152, 2454, 127, 408075536, 8129732, "GAP", "Intersection" ], 
  [ 936, 2601, 3, 586247910, 48048, "GAP", "PQuotient" ], 
  [ 29304, 2903, 30, 247334502, 15072, "(oprt.)", "PreImagesRepresentative" ],
  [ 183, 52, 3657, 1227240, 791845628, "", "FindIntersections" ], 
  [ 4152, 1170, 2608, 195357168, 413605760, "(oprt.)", "Core" ], 
  [ 96586, 3847, 37, 329819597, 107776, "GAP", "Image" ], 
  [ 1, 15, 5784, 1240, 854502784, "", "FindTQuotients" ], 
  [ 168, 6072, 63, 677285231, 3530522, "GAP", "SMTX_BasesMaximalSubmodules" ],
  [ 9439, 7595, 7, 1165258736, 399408, "", "IsSubgroupFp" ], 
  [ 490, 509, 7836, 32206440, 1213407998, "", "AddGroup" ], 
  [ 339, 7238, 1663, 680437146, 143008272, "", "PullBackH" ], 
  [ 4836, 9329, 280, 1710354579, 34717016, "GAP", "PreImage" ], 
  [ 339, 37, 9600, 2834984, 1744672596, "(oprt.)", "Kernel" ], 
  [ 485, 736, 41309, 68222474, 5062701695, "", "FindPModules" ], 
  [ 184, 4, 42060, 14440, 5132574337, "", "FindPQuotients" ], 
  [ 1, 0, 51572, 112, 6780165669, "", "LowIndexNormal" ] ];
