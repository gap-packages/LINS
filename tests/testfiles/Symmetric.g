...
# computes a presentation of the symmetric group on n points
SymmetricGroupFP := function(n)
  return Image(IsomorphismFpGroup(SymmetricGroup(n)));
end;

ToTest := [
["Sym(6)", SymmetricGroupFP(6), 1000],
["Sym(7)", SymmetricGroupFP(7), 1000],
["Sym(8)", SymmetricGroupFP(8), 1000],
["Sym(9)", SymmetricGroupFP(9), 1000]
];
