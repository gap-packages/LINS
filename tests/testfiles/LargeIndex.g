...
ToTest := [
["$C_2*C_3$", FreeProduct(CyclicGroup(2),CyclicGroup(3)), 5000],
["$C_2*C_8$", FreeProduct(CyclicGroup(2),CyclicGroup(8)), 2000],
];
for i in [1..Length(ToTest)] do
  ...
  PrintTo(Concatenation("./tests/latex/", testname, "/subtest", 
String(i), "/CompareMagmaHeader"), "Total Time (in s) in MAGMA: ", 
MAGMA_time);
